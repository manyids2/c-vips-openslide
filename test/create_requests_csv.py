...
#         "request.size.x",
#         "request.size.y",
#         "native.fractional_coordinates.x",
#         "native.fractional_coordinates.y",
#         "native.native_size.x",
#         "native.native_size.y",
#     ],
# )
# df = df.astype(
#     {
...
#         "size.x": int,
#         "size.y": int,
#         "request.location.x": int,
#         "request.location.y": int,
#         "request.level": int,
#         "request.size.x": int,
#         "request.size.y": int,
#     }
# )
# df.to_csv("./requests_new.csv", index=False)
